...
with_node \
  ...
  --target "/Users/macos/rockgymapp/ios/Pods/Target Support Files/Pods-RockGymIasi/ExpoModulesProvider.swift" \
  --entitlement "/Users/macos/rockgymapp/ios/RockGymIasi/RockGymIasi.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-camera" "expo-constants" "expo-eas-client" "expo-file-system" "expo-font" "expo-keep-awake" "expo-splash-screen" "expo-updates"
